      ...
      <div className="Groupies">
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Chief</p>
            <p>
              <a href="mailto:tamara.juric@d-group.se">
                tamara.juric@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Ca$h</p>
            <p>
              <a href="mailto:emma.wahlund@d-group.se">
                emma.wahlund@d-group.se
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>
              <a href="mailto:marcus.doberl@d-group.se">
                marcus.doberl@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Werk</p>
            <p>
              <a href="mailto:anton.bergman@d-group.se">
                anton.bergman@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Pr & Event</p>
            <p>
              <a href="mailto:axel.peters@d-group.se">axel.peters@d-group.se</a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>J^8</p>
            <p>
              <a href="mailto:shamil.limbasiya@d-group.se">
                shamil.limbasiya@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Spons</p>
            <p>
              <a href="mailto:alice.bramstedt@d-group.se">
                alice.bramstedt@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Trykk</p>
            <p>
              <a href="mailto:emma.siklosi@d-group.se">
                emma.siklosi@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Biljett & U-Lag</p>
            <p>
              <a href="mailto:elias.hornberg@d-group.se">
                elias.hornberg@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Mat & Sittning</p>
            <p>
              <a href="mailto:oscar.stolpe@d-group.se">
                oscar.stolpe@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Trykk</p>
            <p>
              <a href="mailto:erik.hilke@d-group.se">erik.hilke@d-group.se</a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Pr & Personal</p>
            <p>
              <a href="mailtojohan.sjostedt@d-group.se">
                johan.sjostedt@d-group.se
              </a>
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <p>Öl & Bar</p>
            <p>
              <a href="mailto:morgan.uvelid@d-group.se">
                morgan.uvelid@d-group.se
              </a>
            </p>
          </div>
        </div>
