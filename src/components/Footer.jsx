    ...
    <Container>
      <div className="row">
            <div class="col-12 col-md-8">
              ...
              , strippförfrågningar, jobbförfrågningar (vi kan jobba på det mesta) eller vad du/ni än må ha på hjärtat görs via mail till <a href="mailto:info@d-group.se">info@D-Group.se</a>. <br/>Frågor om D-Group.se, Tentakravallen.se, <a href ="https://Dömd.nu">DömD.nu</a>  ställs
