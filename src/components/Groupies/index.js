...
function GroupieGrid() {
  const Groupies = [
    ...
    },
    {
      ...
      cons: "Att inte däcka",
      relation: "Nunna",
      party: "Jamar hårade än alla andra",
    },
    {
    ...
    },
    {
      ...
      home: "Täbyyyy",
      pors: "----------",
      cons: "bakisÅngest och Werks röv",
      relation: "Nunna",
      ...
      <Grid container>
        <Grid xs={12} md={4} sx={{ p:{xs:1, md:2} }} /* About card */>
          ...
          <Typography variant="h6" guttomButtom>
            ...
            världen var svart-vit och popcorn inte gick att göra i micron. Innan
            dess låg vi i mammas kära mage och smed planer om världsherravälde
            genom pilkastning, ölhäfv och självrökande cigaretter. Vi tycker om
            att ha kul!
          </Typography>
        </Grid>
